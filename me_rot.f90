       ...
       do k1 = -j,j
          ...
          do k2 = -j,j
             ...
             if (abs(k1-k2)==2) then
                ...
                !
                if (verbose>=7) write(out,"('j,k1,k2,pm,fjk = ',4i0,3e18.8)") j,k1,k2,pm,fjk,jx2y2mat(j,k1,k2),jxymat(j,k1,k2)
                !
             endif 
             !
...
!
 function mult_rot_me(j,k1,k2,tau1,tau2,me) result (f)
   ...
   real(ark) ::  minus1,minus2,minus12,fk1,fk2
      ...
      !
      if (verbose>=6) write(out,"('j,k1,k2,minus1,minus1,minus12 = ',3i0,5e18.8)") j,k1,k2,minus1,minus1,minus12
