...
subroutine potC2H2_D8h_diff_V(n,y1,y2,y3,y4,y5,y6,y7,dF)
    ...
    real(ark),intent(out) :: dF(n)
      ...
      dF(17) = y2*y3**2+y2**2*y3
      dF(18) = y2**3+y3**3
      dF(19) = (y7**2+y4**2+y6**2+y5**2)*y1
      dF(20) = (y4*y6+y5*y7)*y1
      dF(21) = y1*y2*y3
      dF(22) = (y2**2+y3**2)*y1
      dF(23) = (y2+y3)*y1**2
      dF(24) = y1**3
      dF(25) = y6**4+2._ark*y4**2*y5**2+2._ark*y6**2*y7**2+y4**4+y7**4+y5**4      
      dF(26) = y4**3*y6+y4**2*y5*y7+(y6**3+y6*y7**2+y5**2*y6)*y4+y5**3*y7+(y7**3+y6**2*y7)*y5
      dF(27) = y5**2*y7**2+y4**2*y6**2+2._ark*y4*y5*y6*y7
      dF(28) = y4**2*y7**2-2._ark*y4*y5*y6*y7+y5**2*y6**2
      dF(29) = (y7**2+y6**2)*y2**2+(y4**2+y5**2)*y3**2
      dF(30) = (y7**2+y6**2+y5**2+y4**2)*y3*y2
      dF(31) = (y5*y7+y4*y6)*y3*y2
      dF(32) = (y5*y7+y4*y6)*y2**2+(y5*y7+y4*y6)*y3**2
      dF(33) = (y4**2+y5**2)*y2**2+(y7**2+y6**2)*y3**2
      dF(34) = y2**2*y3**2
      dF(35) = y2**3*y3+y2*y3**3
      dF(36) = y2**4+y3**4
      dF(37) = ((y5*y7+y4*y6)*y2+(y5*y7+y4*y6)*y3)*y1
      dF(38) = ((y7**2+y6**2)*y2+(y4**2+y5**2)*y3)*y1
      dF(39) = (y3**3+y2**3)*y1
      dF(40) = ((y4**2+y5**2)*y2+(y7**2+y6**2)*y3)*y1
      dF(41) = (y2*y3**2+y2**2*y3)*y1
      dF(42) = (y5*y7+y4*y6)*y1**2
      dF(43) = (y7**2+y6**2+y5**2+y4**2)*y1**2
      dF(44) = (y3**2+y2**2)*y1**2
      dF(45) = y1**2*y2*y3
      dF(46) = (y2+y3)*y1**3
      dF(47) = y1**4
      dF(48) = (2._ark*y4**2*y5**2+y4**4+y5**4)*y2+(y6**4+y7**4+2._ark*y6**2*y7**2)*y3
      dF(49) = (y4**2*y7**2-2._ark*y4*y5*y6*y7+y5**2*y6**2)*y2+(y4**2*y7**2-2._ark*y4*y5*y6*y7+y5**2*y6**2)*y3
      dF(50) = (y4**3*y6+y4**2*y5*y7+y4*y5**2*y6+y5**3*y7)*y2+((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3
      dF(51) = (y5**2*y7**2+y4**2*y6**2+2._ark*y4*y5*y6*y7)*y2+(y5**2*y7**2+y4**2*y6**2+2._ark*y4*y5*y6*y7)*y3
      dF(52) = ((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y2+(y4**3*y6+y4**2*y5*y7+y4*y5**2*y6+y5**3*y7)*y3
      dF(53) = (y6**4+y7**4+2._ark*y6**2*y7**2)*y2+(2._ark*y4**2*y5**2+y4**4+y5**4)*y3
      dF(54) = y2*y3**4+y2**4*y3
      dF(55) = (y7**2+y6**2)*y3*y2**2+(y5**2+y4**2)*y3**2*y2
      dF(56) = (y5*y7+y4*y6)*y3*y2**2+(y5*y7+y4*y6)*y3**2*y2
      dF(57) = (y5**2+y4**2)*y3*y2**2+(y7**2+y6**2)*y3**2*y2
      dF(58) = (y7**2+y6**2)*y2**3+(y5**2+y4**2)*y3**3
      dF(59) = (y5**2+y4**2)*y2**3+(y7**2+y6**2)*y3**3
      dF(60) = (y5*y7+y4*y6)*y2**3+(y5*y7+y4*y6)*y3**3
      dF(61) = y2**3*y3**2+y2**2*y3**3
      dF(62) = y2**5+y3**5
      dF(63) = (y4**3*y6+y4**2*y5*y7+(y5**2*y6+y6*y7**2+y6**3)*y4+y5**3*y7+(y7**3+y6**2*y7)*y5)*y1
      dF(64) = (y4**2*y7**2-2._ark*y4*y5*y6*y7+y5**2*y6**2)*y1
      dF(65) = (y5**2*y7**2+y4**2*y6**2+2._ark*y4*y5*y6*y7)*y1
      dF(66) = (y4**4+2._ark*y6**2*y7**2+2._ark*y4**2*y5**2+y5**4+y7**4+y6**4)*y1
      dF(67) = ((y5**2+y4**2)*y2**2+(y7**2+y6**2)*y3**2)*y1
      dF(68) = (y5*y7+y4*y6)*y3*y2*y1
      dF(69) = (y4**2+y5**2+y6**2+y7**2)*y3*y2*y1
      dF(70) = ((y7**2+y6**2)*y2**2+(y5**2+y4**2)*y3**2)*y1
      dF(71) = ((y5*y7+y4*y6)*y2**2+(y5*y7+y4*y6)*y3**2)*y1
      dF(72) = y1*y2**2*y3**2
      dF(73) = (y2*y3**3+y2**3*y3)*y1
      dF(74) = (y2**4+y3**4)*y1
      dF(75) = ((y7**2+y6**2)*y2+(y5**2+y4**2)*y3)*y1**2
      dF(76) = ((y5*y7+y4*y6)*y2+(y5*y7+y4*y6)*y3)*y1**2
      dF(77) = ((y5**2+y4**2)*y2+(y7**2+y6**2)*y3)*y1**2
      dF(78) = (y2*y3**2+y2**2*y3)*y1**2
      dF(79) = (y2**3+y3**3)*y1**2
      dF(80) = (y5*y7+y4*y6)*y1**3
      dF(81) = (y4**2+y5**2+y6**2+y7**2)*y1**3
      dF(82) = y1**3*y2*y3
      dF(83) = (y2**2+y3**2)*y1**3
      dF(84) = (y2+y3)*y1**4
      dF(85) = y1**5
      dF(86) = y5**6+3._ark*y6**4*y7**2+3._ark*y4**4*y5**2+3._ark*y6**2*y7**4+y6**6+y4**6+y7**6+3._ark*y4**2*y5**4
      dF(87) = y4**5*y6+y4**4*y5*y7+2._ark*y4**3*y5**2*y6+2._ark*y4**2*y5**3*y7+(y6**5+y6*y7**4+y5**4*y6+2._ark*y6**3*y7**2)*y4+y5**5*y7+(y6**4*y7+2._ark*y6**2*y7**3+y7**5)*y5
      dF(88) = y4**3*y6*y7**2+(y7**3-2._ark*y6**2*y7)*y5*y4**2+(y6**3-2._ark*y6*y7**2)*y5**2*y4+y5**3*y6**2*y7
      dF(89) = y4**3*y6**3+y5**3*y7**3+3._ark*y4**2*y5*y6**2*y7+3._ark*y4*y5**2*y6*y7**2
      dF(90) = y4**4*y7**2-2._ark*y4**3*y5*y6*y7+((y6**2+y7**2)*y5**2+y6**2*y7**2+y7**4)*y4**2+(-2._ark*y5**3*y6*y7+(-2._ark*y6*y7**3-2._ark*y6**3*y7)*y5)*y4+y5**4*y6**2+(y6**2*y7**2+y6**4)*y5**2
      dF(91) = y4**4*y6**2+2._ark*y4**3*y5*y6*y7+((y6**2+y7**2)*y5**2+y6**2*y7**2+y6**4)*y4**2+(2._ark*y5**3*y6*y7+(2._ark*y6*y7**3+2._ark*y6**3*y7)*y5)*y4+y5**4*y7**2+(y6**2*y7**2+y7**4)*y5**2
      dF(92) = (y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y3*y2
      dF(93) = (y4**3*y6+y4**2*y5*y7+(y6*y7**2+y5**2*y6+y6**3)*y4+y5**3*y7+(y7**3+y6**2*y7)*y5)*y3*y2
      dF(94) = (y4**2*y6**2+2._ark*y4*y5*y6*y7+y5**2*y7**2)*y3*y2
      dF(95) = (y4**4+y7**4+y6**4+y5**4+2._ark*y6**2*y7**2+2._ark*y4**2*y5**2)*y3*y2
      dF(96) = (2._ark*y6**2*y7**2+y7**4+y6**4)*y2**2+(y5**4+y4**4+2._ark*y4**2*y5**2)*y3**2
      dF(97) = ((y6*y7**2+y6**3)*y4+(y7**3+y6**2*y7)*y5)*y2**2+(y4*y5**2*y6+y4**3*y6+y5**3*y7+y4**2*y5*y7)*y3**2
      dF(98) = (y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y2**2+(y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y3**2
      dF(99) = (y4**2*y6**2+2._ark*y4*y5*y6*y7+y5**2*y7**2)*y2**2+(y4**2*y6**2+2._ark*y4*y5*y6*y7+y5**2*y7**2)*y3**2
      dF(100) = (y4*y5**2*y6+y4**3*y6+y5**3*y7+y4**2*y5*y7)*y2**2+((y6*y7**2+y6**3)*y4+(y7**3+y6**2*y7)*y5)*y3**2
      dF(101) = (y5**4+y4**4+2._ark*y4**2*y5**2)*y2**2+(2._ark*y6**2*y7**2+y7**4+y6**4)*y3**2
      dF(102) = (y4*y6+y5*y7)*y3**2*y2**2
      dF(103) = (y4**2+y7**2+y6**2+y5**2)*y3**2*y2**2
      dF(104) = (y6**2+y7**2)*y3*y2**3+(y5**2+y4**2)*y3**3*y2
      dF(105) = (y4*y6+y5*y7)*y3*y2**3+(y4*y6+y5*y7)*y3**3*y2
      dF(106) = (y5**2+y4**2)*y3*y2**3+(y6**2+y7**2)*y3**3*y2
      dF(107) = y2**3*y3**3
      dF(108) = (y6**2+y7**2)*y2**4+(y5**2+y4**2)*y3**4
      dF(109) = (y5**2+y4**2)*y2**4+(y6**2+y7**2)*y3**4
      dF(110) = (y4*y6+y5*y7)*y2**4+(y4*y6+y5*y7)*y3**4
      dF(111) = y2**4*y3**2+y2**2*y3**4
      dF(112) = y2*y3**5+y2**5*y3
      dF(113) = y2**6+y3**6
      dF(114) = ((y5**2+y4**2)*y2**3+(y6**2+y7**2)*y3**3)*y1
      dF(115) = ((y4*y6+y5*y7)*y2**3+(y4*y6+y5*y7)*y3**3)*y1
      dF(116) = ((y6**2+y7**2)*y2**3+(y5**2+y4**2)*y3**3)*y1
      dF(117) = (y3**5+y2**5)*y1
      dF(118) = ((2._ark*y6**2*y7**2+y7**4+y6**4)*y2+(y5**4+y4**4+2._ark*y4**2*y5**2)*y3)*y1
      dF(119) = ((y5**4+y4**4+2._ark*y4**2*y5**2)*y2+(2._ark*y6**2*y7**2+y7**4+y6**4)*y3)*y1
      dF(120) = (((y6*y7**2+y6**3)*y4+(y7**3+y6**2*y7)*y5)*y2+(y4*y5**2*y6+y4**3*y6+y5**3*y7+y4**2*y5*y7)*y3)*y1
      dF(121) = ((y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y2+(y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y3)*y1
      dF(122) = ((y4**2*y6**2+2._ark*y4*y5*y6*y7+y5**2*y7**2)*y2+(y4**2*y6**2+2._ark*y4*y5*y6*y7+y5**2*y7**2)*y3)*y1
      dF(123) = ((y4*y5**2*y6+y4**3*y6+y5**3*y7+y4**2*y5*y7)*y2+((y6*y7**2+y6**3)*y4+(y7**3+y6**2*y7)*y5)*y3)*y1
      dF(124) = ((y6**2+y7**2)*y3*y2**2+(y5**2+y4**2)*y3**2*y2)*y1
      dF(125) = ((y4*y6+y5*y7)*y3*y2**2+(y4*y6+y5*y7)*y3**2*y2)*y1
      dF(126) = ((y5**2+y4**2)*y3*y2**2+(y6**2+y7**2)*y3**2*y2)*y1
      dF(127) = (y2**3*y3**2+y2**2*y3**3)*y1
      dF(128) = (y2**4*y3+y2*y3**4)*y1
      dF(129) = (y4**2*y6**2+2._ark*y4*y5*y6*y7+y5**2*y7**2)*y1**2
      dF(130) = (y4**4+y7**4+y6**4+y5**4+2._ark*y6**2*y7**2+2._ark*y4**2*y5**2)*y1**2
      dF(131) = (y4**3*y6+y4**2*y5*y7+(y6*y7**2+y5**2*y6+y6**3)*y4+y5**3*y7+(y7**3+y6**2*y7)*y5)*y1**2
      dF(132) = (y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y1**2
      dF(133) = (y4*y6+y5*y7)*y3*y2*y1**2
      dF(134) = (y4**2+y7**2+y6**2+y5**2)*y3*y2*y1**2
      dF(135) = ((y6**2+y7**2)*y2**2+(y5**2+y4**2)*y3**2)*y1**2
      dF(136) = ((y4*y6+y5*y7)*y2**2+(y4*y6+y5*y7)*y3**2)*y1**2
      dF(137) = ((y5**2+y4**2)*y2**2+(y6**2+y7**2)*y3**2)*y1**2
      dF(138) = y1**2*y2**2*y3**2
      dF(139) = (y2**3*y3+y2*y3**3)*y1**2
      dF(140) = (y2**4+y3**4)*y1**2
      dF(141) = ((y6**2+y7**2)*y2+(y5**2+y4**2)*y3)*y1**3
      dF(142) = ((y4*y6+y5*y7)*y2+(y4*y6+y5*y7)*y3)*y1**3
      dF(143) = ((y5**2+y4**2)*y2+(y6**2+y7**2)*y3)*y1**3
      dF(144) = (y2*y3**2+y2**2*y3)*y1**3
      dF(145) = (y2**3+y3**3)*y1**3
      dF(146) = (y4**2+y7**2+y6**2+y5**2)*y1**4
      dF(147) = (y4*y6+y5*y7)*y1**4
      dF(148) = y1**4*y2*y3
      dF(149) = (y2**2+y3**2)*y1**4
      dF(150) = (y2+y3)*y1**5
      dF(151) = y1**6
      dF(152) = ((y6**2*y7**2+y6**4)*y4**2+(2._ark*y6*y7**3+2._ark*y6**3*y7)*y5*y4+(y7**4+y6**2*y7**2)*y5**2)*y2+(y4**4*y6**2+2._ark*y4**3*y5*y6*y7+(y6**2+y7**2)*y5**2*y4**2+2._ark*y4*y5**3*y6*y7+y5**4*y7**2)*y3
      dF(153) = (y4**4*y6**2+2._ark*y4**3*y5*y6*y7+(y6**2+y7**2)*y5**2*y4**2+2._ark*y4*y5**3*y6*y7+y5**4*y7**2)*y2+((y6**2*y7**2+y6**4)*y4**2+(2._ark*y6*y7**3+2._ark*y6**3*y7)*y5*y4+(y7**4+y6**2*y7**2)*y5**2)*y3
      dF(154) = ((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y2**3+(y4*y5**2*y6+y5**3*y7+y4**2*y5*y7+y4**3*y6)*y3**3
      dF(155) = (y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y2**3+(y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y3**3
      dF(156) = (y5**2*y7**2+2._ark*y4*y5*y6*y7+y4**2*y6**2)*y2**3+(y5**2*y7**2+2._ark*y4*y5*y6*y7+y4**2*y6**2)*y3**3
      dF(157) = (3._ark*y6**4*y7**2+3._ark*y6**2*y7**4+y7**6+y6**6)*y2+(y5**6+y4**6+3._ark*y4**2*y5**4+3._ark*y4**4*y5**2)*y3
      dF(158) = ((y6**5+y6*y7**4+2._ark*y6**3*y7**2)*y4+(y7**5+y6**4*y7+2._ark*y6**2*y7**3)*y5)*y2+(y5**5*y7+y4**5*y6+y4*y5**4*y6+2._ark*y4**2*y5**3*y7+y4**4*y5*y7+2._ark*y4**3*y5**2*y6)*y3
      dF(159) = ((y7**4+y6**2*y7**2)*y4**2+(-2._ark*y6*y7**3-2._ark*y6**3*y7)*y5*y4+(y6**2*y7**2+y6**4)*y5**2)*y2+(y4**4*y7**2-2._ark*y4**3*y5*y6*y7+(y6**2+y7**2)*y5**2*y4**2-2._ark*y4*y5**3*y6*y7+y5**4*y6**2)*y3
      dF(160) = (3._ark*y4*y5**2*y6*y7**2+y5**3*y7**3+3._ark*y4**2*y5*y6**2*y7+y4**3*y6**3)*y2+(3._ark*y4*y5**2*y6*y7**2+y5**3*y7**3+3._ark*y4**2*y5*y6**2*y7+y4**3*y6**3)*y3
      dF(161) = (y4**3*y6*y7**2+(y7**3-2._ark*y6**2*y7)*y5*y4**2+(y6**3-2._ark*y6*y7**2)*y5**2*y4+y5**3*y6**2*y7)*y2+(y4**3*y6*y7**2+(y7**3-2._ark*y6**2*y7)*y5*y4**2+(y6**3-2._ark*y6*y7**2)*y5**2*y4+y5**3*y6**2*y7)*y3
      dF(162) = (y4**4*y7**2-2._ark*y4**3*y5*y6*y7+(y6**2+y7**2)*y5**2*y4**2-2._ark*y4*y5**3*y6*y7+y5**4*y6**2)*y2+((y7**4+y6**2*y7**2)*y4**2+(-2._ark*y6*y7**3-2._ark*y6**3*y7)*y5*y4+(y6**2*y7**2+y6**4)*y5**2)*y3
      dF(163) = (y5**5*y7+y4**5*y6+y4*y5**4*y6+2._ark*y4**2*y5**3*y7+y4**4*y5*y7+2._ark*y4**3*y5**2*y6)*y2+((y6**5+y6*y7**4+2._ark*y6**3*y7**2)*y4+(y7**5+y6**4*y7+2._ark*y6**2*y7**3)*y5)*y3
      dF(164) = (y5**6+y4**6+3._ark*y4**2*y5**4+3._ark*y4**4*y5**2)*y2+(3._ark*y6**4*y7**2+3._ark*y6**2*y7**4+y7**6+y6**6)*y3
      dF(165) = ((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3*y2**2+(y4*y5**2*y6+y5**3*y7+y4**2*y5*y7+y4**3*y6)*y3**2*y2
      dF(166) = (y4*y6+y5*y7)*y3*y2**4+(y4*y6+y5*y7)*y3**4*y2
      dF(167) = (y7**4+2._ark*y6**2*y7**2+y6**4)*y3*y2**2+(2._ark*y4**2*y5**2+y4**4+y5**4)*y3**2*y2
      dF(168) = (y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y3*y2**2+(y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y3**2*y2
      dF(169) = (y4*y5**2*y6+y5**3*y7+y4**2*y5*y7+y4**3*y6)*y3*y2**2+((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3**2*y2
      dF(170) = (2._ark*y4**2*y5**2+y4**4+y5**4)*y3*y2**2+(y7**4+2._ark*y6**2*y7**2+y6**4)*y3**2*y2
      dF(171) = (y5**2*y7**2+2._ark*y4*y5*y6*y7+y4**2*y6**2)*y3*y2**2+(y5**2*y7**2+2._ark*y4*y5*y6*y7+y4**2*y6**2)*y3**2*y2
      dF(172) = (y5**2+y4**2)*y3**2*y2**3+(y6**2+y7**2)*y3**3*y2**2
      dF(173) = (y4*y6+y5*y7)*y3**2*y2**3+(y4*y6+y5*y7)*y3**3*y2**2
      dF(174) = (y6**2+y7**2)*y3**2*y2**3+(y5**2+y4**2)*y3**3*y2**2
      dF(175) = (y7**4+2._ark*y6**2*y7**2+y6**4)*y2**3+(2._ark*y4**2*y5**2+y4**4+y5**4)*y3**3
      dF(176) = (y4*y5**2*y6+y5**3*y7+y4**2*y5*y7+y4**3*y6)*y2**3+((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3**3
      dF(177) = (2._ark*y4**2*y5**2+y4**4+y5**4)*y2**3+(y7**4+2._ark*y6**2*y7**2+y6**4)*y3**3
      dF(178) = (y6**2+y7**2)*y3*y2**4+(y5**2+y4**2)*y3**4*y2
      dF(179) = (y5**2+y4**2)*y3*y2**4+(y6**2+y7**2)*y3**4*y2
      dF(180) = y2**4*y3**3+y2**3*y3**4
      dF(181) = (y6**2+y7**2)*y2**5+(y5**2+y4**2)*y3**5
      dF(182) = (y4*y6+y5*y7)*y2**5+(y4*y6+y5*y7)*y3**5
      dF(183) = (y5**2+y4**2)*y2**5+(y6**2+y7**2)*y3**5
      dF(184) = y2**5*y3**2+y2**2*y3**5
      dF(185) = y2*y3**6+y2**6*y3
      dF(186) = y2**7+y3**7
      dF(187) = (y4**6+y7**6+3._ark*y4**2*y5**4+3._ark*y4**4*y5**2+y5**6+3._ark*y6**4*y7**2+3._ark*y6**2*y7**4+y6**6)*y1
      dF(188) = (y4**3*y6*y7**2+(y7**3-2._ark*y6**2*y7)*y5*y4**2+(y6**3-2._ark*y6*y7**2)*y5**2*y4+y5**3*y6**2*y7)*y1
      dF(189) = (y4**4*y6**2+2._ark*y4**3*y5*y6*y7+((y6**2+y7**2)*y5**2+y6**2*y7**2+y6**4)*y4**2+(2._ark*y5**3*y6*y7+(2._ark*y6*y7**3+2._ark*y6**3*y7)*y5)*y4+y5**4*y7**2+(y7**4+y6**2*y7**2)*y5**2)*y1
      dF(190) = (y4**4*y7**2-2._ark*y4**3*y5*y6*y7+((y6**2+y7**2)*y5**2+y7**4+y6**2*y7**2)*y4**2+(-2._ark*y5**3*y6*y7+(-2._ark*y6*y7**3-2._ark*y6**3*y7)*y5)*y4+y5**4*y6**2+(y6**2*y7**2+y6**4)*y5**2)*y1
      dF(191) = (y4**5*y6+y4**4*y5*y7+2._ark*y4**3*y5**2*y6+2._ark*y4**2*y5**3*y7+(y6**5+2._ark*y6**3*y7**2+y5**4*y6+y6*y7**4)*y4+y5**5*y7+(y7**5+y6**4*y7+2._ark*y6**2*y7**3)*y5)*y1
      dF(192) = (3._ark*y4*y5**2*y6*y7**2+y5**3*y7**3+3._ark*y4**2*y5*y6**2*y7+y4**3*y6**3)*y1
      dF(193) = (y7**4+y5**4+y6**4+2._ark*y4**2*y5**2+y4**4+2._ark*y6**2*y7**2)*y3*y2*y1
      dF(194) = (y4**3*y6+y4**2*y5*y7+(y6*y7**2+y6**3+y5**2*y6)*y4+y5**3*y7+(y7**3+y6**2*y7)*y5)*y3*y2*y1
      dF(195) = (y5**2*y7**2+2._ark*y4*y5*y6*y7+y4**2*y6**2)*y3*y2*y1
      dF(196) = (y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y3*y2*y1
      dF(197) = ((y6**2+y7**2)*y3*y2**3+(y5**2+y4**2)*y3**3*y2)*y1
      dF(198) = (y2*y3**5+y2**5*y3)*y1
      dF(199) = ((y7**4+2._ark*y6**2*y7**2+y6**4)*y2**2+(2._ark*y4**2*y5**2+y4**4+y5**4)*y3**2)*y1
      dF(200) = (((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y2**2+(y4*y5**2*y6+y5**3*y7+y4**2*y5*y7+y4**3*y6)*y3**2)*y1
      dF(201) = ((y5**2*y7**2+2._ark*y4*y5*y6*y7+y4**2*y6**2)*y2**2+(y5**2*y7**2+2._ark*y4*y5*y6*y7+y4**2*y6**2)*y3**2)*y1
      dF(202) = ((y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y2**2+(y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y3**2)*y1
      dF(203) = ((y4*y5**2*y6+y5**3*y7+y4**2*y5*y7+y4**3*y6)*y2**2+((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3**2)*y1
      dF(204) = ((2._ark*y4**2*y5**2+y4**4+y5**4)*y2**2+(y7**4+2._ark*y6**2*y7**2+y6**4)*y3**2)*y1
      dF(205) = (y4*y6+y5*y7)*y3**2*y2**2*y1
      dF(206) = (y4**2+y5**2+y6**2+y7**2)*y3**2*y2**2*y1
      dF(207) = (y2**2*y3**4+y2**4*y3**2)*y1
      dF(208) = ((y5**2+y4**2)*y3*y2**3+(y6**2+y7**2)*y3**3*y2)*y1
      dF(209) = ((y4*y6+y5*y7)*y3*y2**3+(y4*y6+y5*y7)*y3**3*y2)*y1
      dF(210) = y1*y2**3*y3**3
      dF(211) = ((y6**2+y7**2)*y2**4+(y5**2+y4**2)*y3**4)*y1
      dF(212) = ((y4*y6+y5*y7)*y2**4+(y4*y6+y5*y7)*y3**4)*y1
      dF(213) = ((y5**2+y4**2)*y2**4+(y6**2+y7**2)*y3**4)*y1
      dF(214) = (y2**6+y3**6)*y1
      dF(215) = ((y5**2*y7**2+2._ark*y4*y5*y6*y7+y4**2*y6**2)*y2+(y5**2*y7**2+2._ark*y4*y5*y6*y7+y4**2*y6**2)*y3)*y1**2
      dF(216) = ((y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y2+(y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y3)*y1**2
      dF(217) = (((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y2+(y4*y5**2*y6+y5**3*y7+y4**2*y5*y7+y4**3*y6)*y3)*y1**2
      dF(218) = ((y7**4+2._ark*y6**2*y7**2+y6**4)*y2+(2._ark*y4**2*y5**2+y4**4+y5**4)*y3)*y1**2
      dF(219) = ((y4*y5**2*y6+y5**3*y7+y4**2*y5*y7+y4**3*y6)*y2+((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3)*y1**2
      dF(220) = ((2._ark*y4**2*y5**2+y4**4+y5**4)*y2+(y7**4+2._ark*y6**2*y7**2+y6**4)*y3)*y1**2
      dF(221) = ((y5**2+y4**2)*y3*y2**2+(y6**2+y7**2)*y3**2*y2)*y1**2
      ...
      dF(225) = (y2**2*y3**3+y2**3*y3**2)*y1**2
      dF(226) = ((y6**2+y7**2)*y2**3+(y5**2+y4**2)*y3**3)*y1**2
      dF(227) = ((y4*y6+y5*y7)*y2**3+(y4*y6+y5*y7)*y3**3)*y1**2
      dF(228) = ((y5**2+y4**2)*y2**3+(y6**2+y7**2)*y3**3)*y1**2
      dF(229) = (y2**5+y3**5)*y1**2
      dF(230) = (y4**3*y6+y4**2*y5*y7+(y6*y7**2+y6**3+y5**2*y6)*y4+y5**3*y7+(y7**3+y6**2*y7)*y5)*y1**3
      dF(231) = (y5**2*y6**2-2._ark*y4*y5*y6*y7+y4**2*y7**2)*y1**3
      dF(232) = (y5**2*y7**2+2._ark*y4*y5*y6*y7+y4**2*y6**2)*y1**3
      dF(233) = (y7**4+y5**4+y6**4+2._ark*y4**2*y5**2+y4**4+2._ark*y6**2*y7**2)*y1**3
      dF(234) = (y3**4+y2**4)*y1**3
      dF(235) = (y4*y6+y5*y7)*y3*y2*y1**3
      dF(236) = (y4**2+y5**2+y6**2+y7**2)*y3*y2*y1**3
      dF(237) = (y2*y3**3+y2**3*y3)*y1**3
      dF(238) = ((y6**2+y7**2)*y2**2+(y5**2+y4**2)*y3**2)*y1**3
      dF(239) = ((y4*y6+y5*y7)*y2**2+(y4*y6+y5*y7)*y3**2)*y1**3
      dF(240) = ((y5**2+y4**2)*y2**2+(y6**2+y7**2)*y3**2)*y1**3
      dF(241) = y1**3*y2**2*y3**2
      dF(242) = ((y6**2+y7**2)*y2+(y5**2+y4**2)*y3)*y1**4
      dF(243) = ((y5**2+y4**2)*y2+(y6**2+y7**2)*y3)*y1**4
      dF(244) = ((y4*y6+y5*y7)*y2+(y4*y6+y5*y7)*y3)*y1**4
      dF(245) = (y2**2*y3+y2*y3**2)*y1**4
      dF(246) = (y2**3+y3**3)*y1**4
      dF(247) = (y4*y6+y5*y7)*y1**5
      dF(248) = (y4**2+y5**2+y6**2+y7**2)*y1**5
      dF(249) = y1**5*y2*y3
      dF(250) = (y2**2+y3**2)*y1**5
      dF(251) = (y2+y3)*y1**6
      dF(252) = y1**7
      dF(253) = y7**8+y6**8+14._ark*y6**4*y7**4+y4**8+y5**8+14._ark*y4**4*y5**4
      dF(254) = y5**4*y7**4+4._ark*y4*y5**3*y6**3*y7+4._ark*y4**3*y5*y6*y7**3+6._ark*y4**2*y5**2*y6**2*y7**2+y4**4*y6**4
      dF(255) = -4._ark*y4*y5**3*y6**3*y7+y5**4*y6**4-4._ark*y4**3*y5*y6*y7**3+y4**4*y7**4+6._ark*y4**2*y5**2*y6**2*y7**2
      dF(256) = y4**6*y6**2+3._ark*y4**5*y5*y6*y7+3._ark*y4**4*y5**2*y6**2+2._ark*y4**3*y5**3*y6*y7+(3._ark*y5**4*y7**2+y6**6+3._ark*y6**4*y7**2)*y4**2+(3._ark*y5**5*y6*y7+(3._ark*y6**5*y7+3._ark*y6*y7**5+2._ark*y6**3*y7**3)*y5)*y4+y5**6*y7**2+(3._ark*y6**2*y7**4+y7**6)*y5**2
      dF(257) = y4**7*y6+7._ark*y4**4*y5**3*y7+7._ark*y4**3*y5**4*y6+(y6**7+7._ark*y6**3*y7**4)*y4+y5**7*y7+(7._ark*y6**4*y7**3+y7**7)*y5
      dF(258) = y4**6*y5*y7+3._ark*y4**5*y5**2*y6-4._ark*y4**4*y5**3*y7-4._ark*y4**3*y5**4*y6+3._ark*y4**2*y5**5*y7+(-4._ark*y6**3*y7**4+3._ark*y6**5*y7**2+y5**6*y6+y6*y7**6)*y4+(y6**6*y7-4._ark*y6**4*y7**3+3._ark*y6**2*y7**5)*y5
      dF(259) = y4**6*y7**2+3._ark*y4**4*y5**2*y6**2-8._ark*y4**3*y5**3*y6*y7+(y7**6+3._ark*y6**4*y7**2+3._ark*y5**4*y7**2)*y4**2-8._ark*y4*y5*y6**3*y7**3+y5**6*y6**2+(3._ark*y6**2*y7**4+y6**6)*y5**2
      dF(260) = y4**5*y6*y7**2+y4**4*y5*y6**2*y7+((-4._ark*y6*y7**2+2._ark*y6**3)*y5**2+2._ark*y6**3*y7**2)*y4**3+((-4._ark*y6**2*y7+2._ark*y7**3)*y5**3+(-4._ark*y6**2*y7**3+y7**5+y6**4*y7)*y5)*y4**2+(y5**4*y6*y7**2+(y6**5-4._ark*y6**3*y7**2+y6*y7**4)*y5**2)*y4+2._ark*y5**3*y6**2*y7**3+y5**5*y6**2*y7
      dF(261) = y4**4*y6**2*y7**2+(y6**4+y7**4-4._ark*y6**2*y7**2)*y5**2*y4**2+y5**4*y6**2*y7**2
      dF(262) = -y4**5*y5*y6*y7+(-y6**2+y7**2)*y5**2*y4**4+2._ark*y4**3*y5**3*y6*y7+((y6**2-y7**2)*y5**4+y6**2*y7**4-y6**4*y7**2)*y4**2+(-y5**5*y6*y7+(-y6*y7**5-y6**5*y7+2._ark*y6**3*y7**3)*y5)*y4+(-y6**2*y7**4+y6**4*y7**2)*y5**2
      dF(263) = y4**2*y5**6+y4**6*y5**2-2._ark*y6**4*y7**4+y6**6*y7**2+y6**2*y7**6-2._ark*y4**4*y5**4
      dF(264) = 3._ark*y4**5*y6*y7**2+y4**4*y5*y7**3+((5._ark*y6**3-9._ark*y6*y7**2)*y5**2+5._ark*y6**3*y7**2+y6*y7**4)*y4**3+((-9._ark*y6**2*y7+5._ark*y7**3)*y5**3+(-9._ark*y6**2*y7**3+3._ark*y7**5)*y5)*y4**2+(y5**4*y6**3+(3._ark*y6**5-9._ark*y6**3*y7**2)*y5**2)*y4+3._ark*y5**5*y6**2*y7+(5._ark*y6**2*y7**3+y6**4*y7)*y5**3
      dF(265) = (-3._ark*y6*y7**2+y6**3)*y4**5+((15._ark*y6*y7**2-5._ark*y6**3)*y5**2+y6**5-5._ark*y6**3*y7**2)*y4**3+((15._ark*y6**2*y7-5._ark*y7**3)*y5**3+(-3._ark*y7**5+15._ark*y6**2*y7**3)*y5)*y4**2+(-3._ark*y6**5+15._ark*y6**3*y7**2)*y5**2*y4+(-3._ark*y6**2*y7+y7**3)*y5**5+(-5._ark*y6**2*y7**3+y7**5)*y5**3
      dF(266) = (y6**3*y7-y6*y7**3)*y5*y4**3+(y6*y7**3-y6**3*y7)*y5**3*y4
      dF(267) = (y5**5*y7+y4**4*y5*y7+2._ark*y4**3*y5**2*y6+2._ark*y4**2*y5**3*y7+y4**5*y6+y4*y5**4*y6)*y2**2+((y6*y7**4+y6**5+2._ark*y6**3*y7**2)*y4+(2._ark*y6**2*y7**3+y6**4*y7+y7**5)*y5)*y3**2
      dF(268) = ((-y6**2+y7**2)*y4**4-4._ark*y4**3*y5*y6*y7-4._ark*y4*y5**3*y6*y7+(y6**2-y7**2)*y5**4)*y2**2+((y7**4-y6**4)*y4**2+(-4._ark*y6*y7**3-4._ark*y6**3*y7)*y5*y4+(y6**4-y7**4)*y5**2)*y3**2
      dF(269) = (y4**4*y6**2+2._ark*y4**3*y5*y6*y7+(y6**2+y7**2)*y5**2*y4**2+2._ark*y4*y5**3*y6*y7+y5**4*y7**2)*y2**2+((y6**4+y6**2*y7**2)*y4**2+(2._ark*y6**3*y7+2._ark*y6*y7**3)*y5*y4+(y6**2*y7**2+y7**4)*y5**2)*y3**2
      dF(270) = ((y6**2*y7**2+y7**4)*y4**2+(-2._ark*y6*y7**3-2._ark*y6**3*y7)*y5*y4+(y6**4+y6**2*y7**2)*y5**2)*y2**2+(y4**4*y7**2-2._ark*y4**3*y5*y6*y7+(y6**2+y7**2)*y5**2*y4**2-2._ark*y4*y5**3*y6*y7+y5**4*y6**2)*y3**2
      dF(271) = (3._ark*y4**2*y5*y6**2*y7+y5**3*y7**3+y4**3*y6**3+3._ark*y4*y5**2*y6*y7**2)*y2**2+(3._ark*y4**2*y5*y6**2*y7+y5**3*y7**3+y4**3*y6**3+3._ark*y4*y5**2*y6*y7**2)*y3**2
      dF(272) = ((y6*y7**4+y6**5+2._ark*y6**3*y7**2)*y4+(2._ark*y6**2*y7**3+y6**4*y7+y7**5)*y5)*y2**2+(y5**5*y7+y4**4*y5*y7+2._ark*y4**3*y5**2*y6+2._ark*y4**2*y5**3*y7+y4**5*y6+y4*y5**4*y6)*y3**2
      dF(273) = (3._ark*y6**4*y7**2+y6**6+y7**6+3._ark*y6**2*y7**4)*y2**2+(y4**6+y5**6+3._ark*y4**4*y5**2+3._ark*y4**2*y5**4)*y3**2
      dF(274) = (y5**4+y4**4+2._ark*y4**2*y5**2)*y2**4+(y7**4+2._ark*y6**2*y7**2+y6**4)*y3**4
      dF(275) = (y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y2**4+(y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y3**4
      dF(276) = (y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y2**4+(y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y3**4
      dF(277) = ((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y2**4+(y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y3**4
      dF(278) = (y7**4+2._ark*y6**2*y7**2+y6**4)*y2**4+(y5**4+y4**4+2._ark*y4**2*y5**2)*y3**4
      dF(279) = (y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y2**4+((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3**4
      dF(280) = (3._ark*y4**2*y5*y6**2*y7+y5**3*y7**3+y4**3*y6**3+3._ark*y4*y5**2*y6*y7**2)*y3*y2
      dF(281) = (y4**3*y6*y7**2+(-2._ark*y6**2*y7+y7**3)*y5*y4**2+(y6**3-2._ark*y6*y7**2)*y5**2*y4+y5**3*y6**2*y7)*y3*y2
      dF(282) = (y4**4*y7**2-2._ark*y4**3*y5*y6*y7+((y6**2+y7**2)*y5**2+y6**2*y7**2+y7**4)*y4**2+(-2._ark*y5**3*y6*y7+(-2._ark*y6*y7**3-2._ark*y6**3*y7)*y5)*y4+y5**4*y6**2+(y6**4+y6**2*y7**2)*y5**2)*y3*y2
      dF(283) = (y4**4*y6**2+2._ark*y4**3*y5*y6*y7+((y6**2+y7**2)*y5**2+y6**4+y6**2*y7**2)*y4**2+(2._ark*y5**3*y6*y7+(2._ark*y6**3*y7+2._ark*y6*y7**3)*y5)*y4+y5**4*y7**2+(y6**2*y7**2+y7**4)*y5**2)*y3*y2
      dF(284) = (y4**5*y6+y4**4*y5*y7+2._ark*y4**3*y5**2*y6+2._ark*y4**2*y5**3*y7+(y6*y7**4+2._ark*y6**3*y7**2+y5**4*y6+y6**5)*y4+y5**5*y7+(2._ark*y6**2*y7**3+y6**4*y7+y7**5)*y5)*y3*y2
      dF(285) = (y4**6+y6**6+y7**6+y5**6+3._ark*y4**4*y5**2+3._ark*y6**4*y7**2+3._ark*y4**2*y5**4+3._ark*y6**2*y7**4)*y3*y2
      dF(286) = ((y6**4-y7**4)*y4**2+(4._ark*y6*y7**3+4._ark*y6**3*y7)*y5*y4+(y7**4-y6**4)*y5**2)*y2**2+((y6**2-y7**2)*y4**4+4._ark*y4**3*y5*y6*y7+4._ark*y4*y5**3*y6*y7+(-y6**2+y7**2)*y5**4)*y3**2
      dF(287) = (y4**6+y5**6+3._ark*y4**4*y5**2+3._ark*y4**2*y5**4)*y2**2+(3._ark*y6**4*y7**2+y6**6+y7**6+3._ark*y6**2*y7**4)*y3**2
      dF(288) = (y4**3*y6*y7**2+(-2._ark*y6**2*y7+y7**3)*y5*y4**2+(y6**3-2._ark*y6*y7**2)*y5**2*y4+y5**3*y6**2*y7)*y2**2+(y4**3*y6*y7**2+(-2._ark*y6**2*y7+y7**3)*y5*y4**2+(y6**3-2._ark*y6*y7**2)*y5**2*y4+y5**3*y6**2*y7)*y3**2
      dF(289) = (y6**4+y4**4+y7**4+y5**4+2._ark*y4**2*y5**2+2._ark*y6**2*y7**2)*y3**2*y2**2
      dF(290) = (y4**3*y6+y4**2*y5*y7+(y6**3+y5**2*y6+y6*y7**2)*y4+y5**3*y7+(y7**3+y6**2*y7)*y5)*y3**2*y2**2
      dF(291) = (y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y3**2*y2**2
      dF(292) = (y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y3**2*y2**2
      dF(293) = y2**2*y3**6+y2**6*y3**2
      dF(294) = (y7**4+2._ark*y6**2*y7**2+y6**4)*y3*y2**3+(y5**4+y4**4+2._ark*y4**2*y5**2)*y3**3*y2
      dF(295) = ((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3*y2**3+(y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y3**3*y2
      dF(296) = (y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y3*y2**3+(y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y3**3*y2
      dF(297) = (y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y3*y2**3+(y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y3**3*y2
      dF(298) = (y5**4+y4**4+2._ark*y4**2*y5**2)*y3*y2**3+(y7**4+2._ark*y6**2*y7**2+y6**4)*y3**3*y2
      dF(299) = (y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y3*y2**3+((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3**3*y2
      dF(300) = (y4*y6+y5*y7)*y3**3*y2**3
      dF(301) = (y4**2+y7**2+y6**2+y5**2)*y3**3*y2**3
      dF(302) = y2**3*y3**5+y2**5*y3**3
      dF(303) = (y6**2+y7**2)*y3**2*y2**4+(y5**2+y4**2)*y3**4*y2**2
      dF(304) = (y4*y6+y5*y7)*y3**2*y2**4+(y4*y6+y5*y7)*y3**4*y2**2
      dF(305) = (y5**2+y4**2)*y3**2*y2**4+(y6**2+y7**2)*y3**4*y2**2
      dF(306) = y2**4*y3**4
      dF(307) = (y6**2+y7**2)*y3*y2**5+(y5**2+y4**2)*y3**5*y2
      dF(308) = (y4*y6+y5*y7)*y3*y2**5+(y4*y6+y5*y7)*y3**5*y2
      dF(309) = (y5**2+y4**2)*y3*y2**5+(y6**2+y7**2)*y3**5*y2
      dF(310) = (y6**2+y7**2)*y2**6+(y5**2+y4**2)*y3**6
      dF(311) = (y4*y6+y5*y7)*y2**6+(y4*y6+y5*y7)*y3**6
      dF(312) = (y5**2+y4**2)*y2**6+(y6**2+y7**2)*y3**6
      dF(313) = y2**7*y3+y2*y3**7
      dF(314) = y2**8+y3**8
      dF(315) = (((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y2**3+(y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y3**3)*y1
      dF(316) = ((3._ark*y6**4*y7**2+y6**6+y7**6+3._ark*y6**2*y7**4)*y2+(y4**6+y5**6+3._ark*y4**4*y5**2+3._ark*y4**2*y5**4)*y3)*y1
      dF(317) = (((y6*y7**4+y6**5+2._ark*y6**3*y7**2)*y4+(2._ark*y6**2*y7**3+y6**4*y7+y7**5)*y5)*y2+(y5**5*y7+y4**4*y5*y7+2._ark*y4**3*y5**2*y6+2._ark*y4**2*y5**3*y7+y4**5*y6+y4*y5**4*y6)*y3)*y1
      dF(318) = (((y6**2*y7**2+y7**4)*y4**2+(-2._ark*y6*y7**3-2._ark*y6**3*y7)*y5*y4+(y6**4+y6**2*y7**2)*y5**2)*y2+(y4**4*y7**2-2._ark*y4**3*y5*y6*y7+(y6**2+y7**2)*y5**2*y4**2-2._ark*y4*y5**3*y6*y7+y5**4*y6**2)*y3)*y1
      dF(319) = (((y6**4-y7**4)*y4**2+(4._ark*y6*y7**3+4._ark*y6**3*y7)*y5*y4+(y7**4-y6**4)*y5**2)*y2+((y6**2-y7**2)*y4**4+4._ark*y4**3*y5*y6*y7+4._ark*y4*y5**3*y6*y7+(-y6**2+y7**2)*y5**4)*y3)*y1
      dF(320) = ((y4**3*y6*y7**2+(-2._ark*y6**2*y7+y7**3)*y5*y4**2+(y6**3-2._ark*y6*y7**2)*y5**2*y4+y5**3*y6**2*y7)*y2+(y4**3*y6*y7**2+(-2._ark*y6**2*y7+y7**3)*y5*y4**2+(y6**3-2._ark*y6*y7**2)*y5**2*y4+y5**3*y6**2*y7)*y3)*y1
      dF(321) = ((3._ark*y4**2*y5*y6**2*y7+y5**3*y7**3+y4**3*y6**3+3._ark*y4*y5**2*y6*y7**2)*y2+(3._ark*y4**2*y5*y6**2*y7+y5**3*y7**3+y4**3*y6**3+3._ark*y4*y5**2*y6*y7**2)*y3)*y1
      dF(322) = ((y4**4*y7**2-2._ark*y4**3*y5*y6*y7+(y6**2+y7**2)*y5**2*y4**2-2._ark*y4*y5**3*y6*y7+y5**4*y6**2)*y2+((y6**2*y7**2+y7**4)*y4**2+(-2._ark*y6*y7**3-2._ark*y6**3*y7)*y5*y4+(y6**4+y6**2*y7**2)*y5**2)*y3)*y1
      dF(323) = ((y4**4*y6**2+2._ark*y4**3*y5*y6*y7+(y6**2+y7**2)*y5**2*y4**2+2._ark*y4*y5**3*y6*y7+y5**4*y7**2)*y2+((y6**4+y6**2*y7**2)*y4**2+(2._ark*y6**3*y7+2._ark*y6*y7**3)*y5*y4+(y6**2*y7**2+y7**4)*y5**2)*y3)*y1
      dF(324) = ((y5**5*y7+y4**4*y5*y7+2._ark*y4**3*y5**2*y6+2._ark*y4**2*y5**3*y7+y4**5*y6+y4*y5**4*y6)*y2+((y6*y7**4+y6**5+2._ark*y6**3*y7**2)*y4+(2._ark*y6**2*y7**3+y6**4*y7+y7**5)*y5)*y3)*y1
      dF(325) = ((y4**6+y5**6+3._ark*y4**4*y5**2+3._ark*y4**2*y5**4)*y2+(3._ark*y6**4*y7**2+y6**6+y7**6+3._ark*y6**2*y7**4)*y3)*y1
      dF(326) = ((y7**4+2._ark*y6**2*y7**2+y6**4)*y3*y2**2+(y5**4+y4**4+2._ark*y4**2*y5**2)*y3**2*y2)*y1
      dF(327) = ((y6**2+y7**2)*y3*y2**4+(y5**2+y4**2)*y3**4*y2)*y1
      dF(328) = (((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3*y2**2+(y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y3**2*y2)*y1
      dF(329) = ((y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y3*y2**2+(y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y3**2*y2)*y1
      dF(330) = ((y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y3*y2**2+(y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y3**2*y2)*y1
      dF(331) = ((y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y3*y2**2+((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3**2*y2)*y1
      dF(332) = ((y5**4+y4**4+2._ark*y4**2*y5**2)*y3*y2**2+(y7**4+2._ark*y6**2*y7**2+y6**4)*y3**2*y2)*y1
      dF(333) = ((y4*y6+y5*y7)*y3**2*y2**3+(y4*y6+y5*y7)*y3**3*y2**2)*y1
      dF(334) = ((y6**2+y7**2)*y3**2*y2**3+(y5**2+y4**2)*y3**3*y2**2)*y1
      dF(335) = (y2**5*y3**2+y2**2*y3**5)*y1
      dF(336) = ((y7**4+2._ark*y6**2*y7**2+y6**4)*y2**3+(y5**4+y4**4+2._ark*y4**2*y5**2)*y3**3)*y1
      dF(337) = ((y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y2**3+(y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y3**3)*y1
      dF(338) = ((y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y2**3+(y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y3**3)*y1
      dF(339) = ((y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y2**3+((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3**3)*y1
      dF(340) = ((y5**4+y4**4+2._ark*y4**2*y5**2)*y2**3+(y7**4+2._ark*y6**2*y7**2+y6**4)*y3**3)*y1
      dF(341) = ((y5**2+y4**2)*y3**2*y2**3+(y6**2+y7**2)*y3**3*y2**2)*y1
      dF(342) = (y2**3*y3**4+y2**4*y3**3)*y1
      dF(343) = ((y4*y6+y5*y7)*y3*y2**4+(y4*y6+y5*y7)*y3**4*y2)*y1
      dF(344) = ((y5**2+y4**2)*y3*y2**4+(y6**2+y7**2)*y3**4*y2)*y1
      dF(345) = ((y6**2+y7**2)*y2**5+(y5**2+y4**2)*y3**5)*y1
      dF(346) = ((y4*y6+y5*y7)*y2**5+(y4*y6+y5*y7)*y3**5)*y1
      dF(347) = ((y5**2+y4**2)*y2**5+(y6**2+y7**2)*y3**5)*y1
      dF(348) = (y2**6*y3+y2*y3**6)*y1
      dF(349) = (y2**7+y3**7)*y1
      dF(350) = (3._ark*y4**2*y5*y6**2*y7+y5**3*y7**3+y4**3*y6**3+3._ark*y4*y5**2*y6*y7**2)*y1**2
      dF(351) = (y4**3*y6*y7**2+(-2._ark*y6**2*y7+y7**3)*y5*y4**2+(y6**3-2._ark*y6*y7**2)*y5**2*y4+y5**3*y6**2*y7)*y1**2
      dF(352) = (y4**4*y6**2+2._ark*y4**3*y5*y6*y7+((y6**2+y7**2)*y5**2+y6**4+y6**2*y7**2)*y4**2+(2._ark*y5**3*y6*y7+(2._ark*y6**3*y7+2._ark*y6*y7**3)*y5)*y4+y5**4*y7**2+(y6**2*y7**2+y7**4)*y5**2)*y1**2
      dF(353) = (y4**4*y7**2-2._ark*y4**3*y5*y6*y7+((y6**2+y7**2)*y5**2+y6**2*y7**2+y7**4)*y4**2+(-2._ark*y5**3*y6*y7+(-2._ark*y6*y7**3-2._ark*y6**3*y7)*y5)*y4+y5**4*y6**2+(y6**4+y6**2*y7**2)*y5**2)*y1**2
      dF(354) = (y4**5*y6+y4**4*y5*y7+2._ark*y4**3*y5**2*y6+2._ark*y4**2*y5**3*y7+(y6*y7**4+2._ark*y6**3*y7**2+y5**4*y6+y6**5)*y4+y5**5*y7+(2._ark*y6**2*y7**3+y6**4*y7+y7**5)*y5)*y1**2
      dF(355) = (y4**6+y6**6+y7**6+y5**6+3._ark*y4**4*y5**2+3._ark*y6**4*y7**2+3._ark*y4**2*y5**4+3._ark*y6**2*y7**4)*y1**2
      dF(356) = (y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y3*y2*y1**2
      dF(357) = (y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y3*y2*y1**2
      dF(358) = (y4**3*y6+y4**2*y5*y7+(y6**3+y5**2*y6+y6*y7**2)*y4+y5**3*y7+(y7**3+y6**2*y7)*y5)*y3*y2*y1**2
      dF(359) = (y6**4+y4**4+y7**4+y5**4+2._ark*y4**2*y5**2+2._ark*y6**2*y7**2)*y3*y2*y1**2
      dF(360) = ((y7**4+2._ark*y6**2*y7**2+y6**4)*y2**2+(y5**4+y4**4+2._ark*y4**2*y5**2)*y3**2)*y1**2
      dF(361) = ((y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y2**2+(y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y3**2)*y1**2
      dF(362) = ((y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y2**2+(y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y3**2)*y1**2
      dF(363) = ((y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y2**2+((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3**2)*y1**2
      dF(364) = (((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y2**2+(y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y3**2)*y1**2
      dF(365) = ((y5**4+y4**4+2._ark*y4**2*y5**2)*y2**2+(y7**4+2._ark*y6**2*y7**2+y6**4)*y3**2)*y1**2
      dF(366) = (y4*y6+y5*y7)*y3**2*y2**2*y1**2
      dF(367) = (y4**2+y7**2+y6**2+y5**2)*y3**2*y2**2*y1**2
      dF(368) = ((y6**2+y7**2)*y3*y2**3+(y5**2+y4**2)*y3**3*y2)*y1**2
      dF(369) = ((y4*y6+y5*y7)*y3*y2**3+(y4*y6+y5*y7)*y3**3*y2)*y1**2
      dF(370) = ((y5**2+y4**2)*y3*y2**3+(y6**2+y7**2)*y3**3*y2)*y1**2
      dF(371) = y1**2*y2**3*y3**3
      dF(372) = ((y6**2+y7**2)*y2**4+(y5**2+y4**2)*y3**4)*y1**2
      dF(373) = ((y4*y6+y5*y7)*y2**4+(y4*y6+y5*y7)*y3**4)*y1**2
      dF(374) = ((y5**2+y4**2)*y2**4+(y6**2+y7**2)*y3**4)*y1**2
      dF(375) = (y2**4*y3**2+y2**2*y3**4)*y1**2
      dF(376) = (y2**5*y3+y2*y3**5)*y1**2
      dF(377) = (y2**6+y3**6)*y1**2
      dF(378) = ((y7**4+2._ark*y6**2*y7**2+y6**4)*y2+(y5**4+y4**4+2._ark*y4**2*y5**2)*y3)*y1**3
      dF(379) = (((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y2+(y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y3)*y1**3
      dF(380) = ((y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y2+(y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y3)*y1**3
      dF(381) = ((y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y2+(y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y3)*y1**3
      dF(382) = ((y4**2*y5*y7+y4**3*y6+y5**3*y7+y4*y5**2*y6)*y2+((y6**3+y6*y7**2)*y4+(y7**3+y6**2*y7)*y5)*y3)*y1**3
      dF(383) = ((y5**4+y4**4+2._ark*y4**2*y5**2)*y2+(y7**4+2._ark*y6**2*y7**2+y6**4)*y3)*y1**3
      dF(384) = ((y6**2+y7**2)*y3*y2**2+(y5**2+y4**2)*y3**2*y2)*y1**3
      dF(385) = ((y4*y6+y5*y7)*y3*y2**2+(y4*y6+y5*y7)*y3**2*y2)*y1**3
      dF(386) = ((y5**2+y4**2)*y3*y2**2+(y6**2+y7**2)*y3**2*y2)*y1**3
      dF(387) = ((y6**2+y7**2)*y2**3+(y5**2+y4**2)*y3**3)*y1**3
      dF(388) = ((y4*y6+y5*y7)*y2**3+(y4*y6+y5*y7)*y3**3)*y1**3
      dF(389) = ((y5**2+y4**2)*y2**3+(y6**2+y7**2)*y3**3)*y1**3
      dF(390) = (y2**3*y3**2+y2**2*y3**3)*y1**3
      dF(391) = (y2**4*y3+y2*y3**4)*y1**3
      dF(392) = (y2**5+y3**5)*y1**3
      dF(393) = (y4**2*y7**2+y5**2*y6**2-2._ark*y4*y5*y6*y7)*y1**4
      dF(394) = (y4**2*y6**2+y5**2*y7**2+2._ark*y4*y5*y6*y7)*y1**4
      dF(395) = (y4**3*y6+y4**2*y5*y7+(y6**3+y5**2*y6+y6*y7**2)*y4+y5**3*y7+(y7**3+y6**2*y7)*y5)*y1**4
      dF(396) = (y6**4+y4**4+y7**4+y5**4+2._ark*y4**2*y5**2+2._ark*y6**2*y7**2)*y1**4
      dF(397) = ((y5**2+y4**2)*y2**2+(y6**2+y7**2)*y3**2)*y1**4
      dF(398) = (y4**2+y7**2+y6**2+y5**2)*y3*y2*y1**4
      dF(399) = (y4*y6+y5*y7)*y3*y2*y1**4
      dF(400) = (y2*y3**3+y2**3*y3)*y1**4
      dF(401) = ((y6**2+y7**2)*y2**2+(y5**2+y4**2)*y3**2)*y1**4
      dF(402) = ((y4*y6+y5*y7)*y2**2+(y4*y6+y5*y7)*y3**2)*y1**4
      dF(403) = y1**4*y2**2*y3**2
      dF(404) = (y2**4+y3**4)*y1**4
      dF(405) = ((y6**2+y7**2)*y2+(y5**2+y4**2)*y3)*y1**5
      dF(406) = ((y4*y6+y5*y7)*y2+(y4*y6+y5*y7)*y3)*y1**5
      dF(407) = ((y5**2+y4**2)*y2+(y6**2+y7**2)*y3)*y1**5
      dF(408) = (y2**2*y3+y2*y3**2)*y1**5
      dF(409) = (y2**3+y3**3)*y1**5
      dF(410) = (y4**2+y7**2+y6**2+y5**2)*y1**6
      dF(411) = (y4*y6+y5*y7)*y1**6
      dF(412) = y1**6*y2*y3
      dF(413) = (y2**2+y3**2)*y1**6
      dF(414) = (y2+y3)*y1**7
      dF(415) = y1**8
 ...
 function MLpoten_c2h2_7_xyz(ncoords,natoms,local,xyz,force) result(f) 
   ...
   real(ark)              ::  f
    ...
    real(ark) :: dF(n)
      ...
      elseif (molec%zmatrix(3)%connect(4)==102) then
         !
         stop 'MLpoten_c2h2_7_xyz 102 is not implemented'
         !
         b1(:) = xyz(3,:)-xyz(1,:)
         b0(:) = xyz(2,:)-xyz(1,:)
         b2(:) = xyz(4,:)-xyz(2,:)
      ...
      !
      call potC2H2_diff_V(n,y1,y2,y3,y4,y5,y6,y7,dF)
      !
      f = 0
      !
