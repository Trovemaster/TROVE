...
module mol_c2h6
  ...
  function ML_coordinate_transform_C2H6(src,ndst,direct) result (dst)
    ...
    !
    real(ark) :: tau16,tau34,tau36,tau24,tau25,tau26,theta12,theta23,theta31,theta56,theta45,theta64,&
    ...
    case('R-R16-BETA16-THETA-TAU-17')
      ...
      if (direct) then ! transform from Z-matrix coords to TROVE coords
        ...
        !tau36 = 1/6*sqrt(2)*s17+1/6*sqrt(2)*s15+1/6*sqrt(6)*s16-1/6*sqrt(6)*s14+tau0
        !
        tau14 = -sqrt(2.0_ark)/3.0_ark*s17-sqrt(2.0_ark)/3.0_ark*s15+S18
        tau24 = -sqrt(2.0_ark)/3.0_ark*s17+sqrt(2.0_ark)/6.0_ark*s15+sqrt(6.0_ark)/6.0_ark*s14+S18-2.0_ark/3.0_ark*pi
        tau25 = sqrt(2.0_ark)/6.0_ark*s17+sqrt(2.0_ark)/6.0_ark*s15-sqrt(6.0_ark)/6.0_ark*s16+sqrt(6.0_ark)/6.0_ark*s14+S18
        tau35 = sqrt(2.0_ark)/6.0_ark*s17+sqrt(2.0_ark)/6.0_ark*s15-sqrt(6.0_ark)/6.0_ark*s16-sqrt(6.0_ark)/6.0_ark*s14+S18&
                -2.0_ark/3.0_ark*pi
        tau36 = sqrt(2.0_ark)/6.0_ark*s17+sqrt(2.0_ark)/6.0_ark*s15+sqrt(6.0_ark)/6.0_ark*s16-sqrt(6.0_ark)/6.0_ark*s14+S18
        !
        dst(14) = mod(tau14+4.0_ark*pi,4.0_ark*pi) ! <- made mod(4pi) 
        dst(15) = mod(tau24+2.0_ark*pi,2.0_ark*pi)
        dst(16) = mod(tau25+4.0_ark*pi,4.0_ark*pi)
    ...
    case('R-R16-BETA16-THETA-TAU-18')
      ...
      if (direct) then ! transform from Z-matrix coords to TROVE coords
        ...
        !
        tau14 = sqrt(2.0_ark)/3.0_ark*s17+sqrt(2.0_ark)/3.0_ark*s15+S18
        tau24 = sqrt(2.0_ark)/3.0_ark*s17-sqrt(2.0_ark)/6.0_ark*s15&
                -sqrt(6.0_ark)/6.0_ark*s14+S18+2.0_ark/3.0_ark*pi
        tau25 = -sqrt(2.0_ark)/6.0_ark*s17-sqrt(2.0_ark)/6.0_ark*s15+sqrt(6.0_ark)/6.0_ark*s16&
                -sqrt(6.0_ark)/6.0_ark*s14+S18
        tau35 = -sqrt(2.0_ark)/6.0_ark*s17-sqrt(2.0_ark)/6.0_ark*s15+&
                 sqrt(6.0_ark)/6.0_ark*s16+sqrt(6.0_ark)/6.0_ark*s14+S18+2.0_ark/3.0_ark*pi
        tau36 = -sqrt(2.0_ark)/6.0_ark*s17-sqrt(2.0_ark)/6.0_ark*s15-sqrt(6.0_ark)/6.0_ark*s16&
                +sqrt(6.0_ark)/6.0_ark*s14+S18
        !
        dst(14) = mod(tau14+4.0_ark*pi,4.0_ark*pi) ! <- made mod(4pi) 
        dst(15) = mod(tau24+2.0_ark*pi,2.0_ark*pi)
    ...
    case('R-R16-BETA16-THETA-TAU-1')
      ...
      if (direct) then ! transform from Z-matrix coords to TROVE coords
        ...
        dst(5) = src(3)-molec%local_eq(3)
        dst(6) = src(7)-molec%local_eq(5)
        dst(7) = src(5)-molec%local_eq(7)
        !
        dst( 8) = src( 8)-molec%local_eq( 8)
        ...
        !
        tau14 = mod(src(14)+4.0_ark*pi,4.0_ark*pi)
        tau34 = mod(src(15)+2.0_ark*pi,2.0_ark*pi)
        tau36 = mod(src(16)+2.0_ark*pi,2.0_ark*pi)
        tau26 = mod(src(17)+2.0_ark*pi,2.0_ark*pi)
        ...
        tau34 = -2.0_ark/3.0_ark*pi+1.0_ark/3.0_ark*sqrt(2.0_ark)*s17-1.0_ark/6.0_ark*sqrt(2.0_ark)*s15+1.0_ark/6.0_ark*sqrt(6.0_ark)*s14+S18
        ...
        tau26 = -1.0_ark/6.0_ark*sqrt(2.0_ark)*s17-1.0_ark/6.0_ark*sqrt(2.0_ark)*s15-1.0_ark/6.0_ark*sqrt(6.0_ark)*s16-1.0_ark/6.0_ark*sqrt(6.0_ark)*s14+S18-2.0_ark/3*pi
        ...
        !
        dst(14) = mod(tau14+4.0_ark*pi,4.0_ark*pi) ! <- made mod(4pi) 
        dst(15) = mod(tau34+2.0_ark*pi,2.0_ark*pi)
        dst(16) = mod(tau36+4.0_ark*pi,4.0_ark*pi)
        dst(17) = mod(tau26+2.0_ark*pi,2.0_ark*pi)
        dst(18) = mod(tau25+4.0_ark*pi,4.0_ark*pi)
        !
      endif 
      ! 
    case('R-R16-BETA16-THETA-TAU-2')
      ...
      if (direct) then ! transform from Z-matrix coords to TROVE coords
        ...
        theta45 = mod(2.0_ark*pi-theta46-theta56+2.0_ark*pi,2.0_ark*pi)
        !
        dst(14)  = ( 2.0_ark*theta23 - theta12 - theta13 )/sqrt(6.0_ark)
        dst(15)  = (                   theta12 - theta13 )/sqrt(2.0_ark)
        !
        ...
        !
        tau14 = -1.0_ark/3.0_ark*sqrt(2.0_ark)*s17-1.0_ark/3.0_ark*sqrt(2.0_ark)*s15+S18        
        tau34 = -1.0_ark/3.0_ark*sqrt(2.0_ark)*s17+1.0_ark/6.0_ark*sqrt(2.0_ark)*s15+1.0_ark/6.0_ark*sqrt(6.0_ark)*s14+S18-2.0_ark/3.0_ark*pi
        tau36 =  1.0_ark/6.0_ark*sqrt(2.0_ark)*s17+1.0_ark/6.0_ark*sqrt(2.0_ark)*s15-1.0_ark/6.0_ark*sqrt(6.0_ark)*s16+1.0_ark/6.0_ark*sqrt(6.0_ark)*s14+S18
        tau26 =  1.0_ark/6.0_ark*sqrt(2.0_ark)*s17+1.0_ark/6.0_ark*sqrt(2.0_ark)*s15-1.0_ark/6.0_ark*sqrt(6.0_ark)*s16-1.0_ark/6.0_ark*sqrt(6.0_ark)*s14+S18-2.0_ark/3.0_ark*pi
        tau25 =  1.0_ark/6.0_ark*sqrt(2.0_ark)*s17+1.0_ark/6.0_ark*sqrt(2.0_ark)*s15+1.0_ark/6.0_ark*sqrt(6.0_ark)*s16-1.0_ark/6.0_ark*sqrt(6.0_ark)*s14+S18
        !
        dst(14) = mod(tau14+4.0_ark*pi,4.0_ark*pi) ! <- made mod(4pi) 
        dst(15) = mod(tau34+2.0_ark*pi,2.0_ark*pi)
    ...
    case('R-R16-BETA16-THETA-TAU-3')
      ...
      if (direct) then ! transform from Z-matrix coords to TROVE coords
        ...
        tau14 = mod(src(14)+4.0_ark*pi,4.0_ark*pi)
        tau34 = mod(src(15)+2.0_ark*pi,2.0_ark*pi)
        tau35 = mod(src(16)+2.0_ark*pi,2.0_ark*pi)
        tau25 = mod(src(17)+2.0_ark*pi,2.0_ark*pi)
        tau26 = mod(src(18)+2.0_ark*pi,2.0_ark*pi)
        !
        ! assuming this is the 404-type (0..720) for tau14, tau25 and tau36 are extended to 0-720 as well
        if (tau14>2.0_ark*pi) then 
           tau26 = tau26 + 2.0_ark*pi
           tau35 = tau35 + 2.0_ark*pi
        endif
        !
        taubar  = ( tau14+tau26+tau35 )/(3.0_ark)
        !
        dst(18) = taubar
        !
        ! for oher dihedral modes the extension is not needed and removed by mod(2 pi)
        ...
        !
        theta13 = mod(tau14-tau34+2.0_ark*pi,2.0_ark*pi)
        theta23 = mod(tau35-tau25+2.0_ark*pi,2.0_ark*pi)
        theta12 = mod(2.0_ark*pi-theta13-theta23+2.0_ark*pi,2.0_ark*pi)
        !
        theta56 = mod(tau26-tau25+2.0_ark*pi,2.0_ark*pi)
        theta45 = mod(tau35-tau34+2.0_ark*pi,2.0_ark*pi)
        theta46 = mod(2.0_ark*pi-theta56-theta45+2.0_ark*pi,2.0_ark*pi)
        !
        dst(14)  = ( 2.0_ark*theta23 - theta13 - theta12 )/sqrt(6.0_ark)
        dst(15)  = (                   theta13 - theta12 )/sqrt(2.0_ark)
        ...
        tau35 = -1.0_ark/6.0_ark*sqrt(2.0_ark)*s17+1.0_ark/6.0_ark*sqrt(2.0_ark)*s15-1.0_ark/6.0_ark*sqrt(6.0_ark)*s16+1.0_ark/6.0_ark*sqrt(6.0_ark)*s14+S18
        tau34 = -2.0_ark/3.0_ark*pi+1.0_ark/3.0_ark*sqrt(2.0_ark)*s17+1.0_ark/6.0_ark*sqrt(2.0_ark)*s15+1.0_ark/6.0_ark*sqrt(6.0_ark)*s14+S18
        tau25 = -1.0_ark/6.0_ark*sqrt(2.0_ark)*s17+1.0_ark/6.0_ark*sqrt(2.0_ark)*s15-1.0_ark/6.0_ark*sqrt(6.0_ark)*s16-1.0_ark/6.0_ark*sqrt(6.0_ark)*s14+S18-2.0_ark/3.0_ark*pi
        tau26 = -1.0_ark/6.0_ark*sqrt(2.0_ark)*s17+1.0_ark/6.0_ark*sqrt(2.0_ark)*s15+1.0_ark/6.0_ark*sqrt(6.0_ark)*s16-1.0_ark/6.0_ark*sqrt(6.0_ark)*s14+S18
        tau14 = 1.0_ark/3.0_ark*sqrt(2.0_ark)*s17-1.0_ark/3.0_ark*sqrt(2.0_ark)*s15+S18
        !
        dst(14) = mod(tau14+4.0_ark*pi,4.0_ark*pi) ! <- made mod(4pi) 
        dst(15) = mod(tau34+2.0_ark*pi,2.0_ark*pi)
  ...
  subroutine ML_b0_C2H6(Npoints,Natoms,b0,rho_i,rho_ref,rho_borders)
    ...
    case('R-R16-BETA16-THETA-TAU-1','R-R16-BETA16-THETA-TAU-2','R-R16-BETA16-THETA-TAU-3')
      ...
      enddo
      !
    case('R-R16-BETA16-THETA-TAU-9','R-R16-BETA16-THETA-TAU-11',&
         'R-R16-BETA16-THETA-TAU-17','R-R16-BETA16-THETA-TAU-18')
      !
      tau = pi
      !
      if (Npoints/=0) then
  ...
  recursive subroutine ML_symmetry_transformation_C2H6(ioper, nmodes, src, dst)
    ...
    case default
      ...
      !
      !
    case('R-R16-BETA16-THETA-TAU-3','R-R16-BETA16-THETA-TAU-11','R-R16-BETA16-THETA-TAU-2',&
         'R-R16-BETA16-THETA-TAU-17','R-R16-BETA16-THETA-TAU-18')
      !
  ...
  subroutine ML_rotsymmetry_C2H6(J,K,tau,gamma,ideg)
    ...
    case('ZMAT_4BETA_1TAU','C2H6_4BETA_1TAU')
      ...
      !
    case('R-R16-BETA16-THETA-TAU-1','R-R16-BETA16-THETA-TAU-2','R-R16-BETA16-THETA-TAU-9','R-R16-BETA16-THETA-TAU-11',&
         'R-R16-BETA16-THETA-TAU-18','R-R16-BETA16-THETA-TAU-3')
      !
      select case(trim(molec%symmetry))
      !
      case('C','C(M)')
