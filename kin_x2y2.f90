...
module kin_x2y2
  ...
  subroutine MLkinetic_compact_x2y2_bisect_EKE_sinrho_rigid(nmodes,rho,ntermmax,ng_vib,ng_rot,ng_cor,npseudo,&
   ...
   integer(ik) :: info,Nterms
     ...
     !Npseudo = 8
     !
     ig_vib(1,1,1,1:6) = (/0,0,0,0,0,0/)
     ig_vib(1,1,1,1:6) = (/0,0,0,0,0,0/)
     ig_vib(1,2,1,1:6) = (/0,0,0,2,0,0/)
     ig_vib(1,3,1,1:6) = (/0,0,0,0,2,0/)
     ig_vib(1,4,1,1:6) = (/0,2,0,1,0,0/)
     ig_vib(1,5,1,1:6) = (/0,0,2,0,1,0/)
     ig_vib(2,1,1,1:6) = (/0,0,0,2,0,0/)
     ig_vib(2,2,1,1:6) = (/0,0,0,0,0,0/)
     ig_vib(2,4,1,1:6) = (/2,0,0,1,0,0/)
     ig_vib(2,5,1,1:6) = (/2,0,0,1,0,0/)
     ig_vib(2,5,2,1:6) = (/2,0,0,1,0,3/)
     ig_vib(2,6,1,1:6) = (/2,0,0,0,2,4/)
     ig_vib(2,6,2,1:6) = (/2,0,0,3,2,4/)
     ig_vib(3,1,1,1:6) = (/0,0,0,0,2,0/)
     ig_vib(3,3,1,1:6) = (/0,0,0,0,0,0/)
     ig_vib(3,4,1,1:6) = (/2,0,0,0,1,0/)
     ig_vib(3,4,2,1:6) = (/2,0,0,0,1,3/)
     ig_vib(3,5,1,1:6) = (/2,0,0,0,1,0/)
     ig_vib(3,6,1,1:6) = (/2,0,0,2,0,4/)
     ig_vib(3,6,2,1:6) = (/2,0,0,2,3,4/)
     ig_vib(4,1,1,1:6) = (/0,2,0,1,0,0/)
     ig_vib(4,2,1,1:6) = (/2,0,0,1,0,0/)
     ig_vib(4,3,1,1:6) = (/2,0,0,0,1,0/)
     ig_vib(4,3,2,1:6) = (/2,0,0,0,1,3/)
     ig_vib(4,4,1,1:6) = (/0,1,0,0,0,0/)
     ig_vib(4,4,2,1:6) = (/1,0,0,0,0,0/)
     ig_vib(4,4,3,1:6) = (/2,2,0,2,0,0/)
     ig_vib(4,5,1,1:6) = (/1,0,0,0,0,0/)
     ig_vib(4,5,2,1:6) = (/1,0,0,0,0,3/)
     ig_vib(4,5,3,1:6) = (/2,0,2,0,2,0/)
     ig_vib(4,5,4,1:6) = (/2,2,0,2,0,0/)
     ig_vib(4,5,5,1:6) = (/2,0,2,0,2,3/)
     ig_vib(4,5,6,1:6) = (/2,2,0,2,0,3/)
     ig_vib(4,6,1,1:6) = (/1,0,0,1,2,4/)
     ig_vib(4,6,2,1:6) = (/2,0,2,1,0,4/)
     ig_vib(4,6,3,1:6) = (/2,2,0,4,2,4/)
     ig_vib(5,1,1,1:6) = (/0,0,2,0,1,0/)
     ig_vib(5,2,1,1:6) = (/2,0,0,1,0,0/)
     ig_vib(5,2,2,1:6) = (/2,0,0,1,0,3/)
     ig_vib(5,3,1,1:6) = (/2,0,0,0,1,0/)
     ig_vib(5,4,1,1:6) = (/1,0,0,0,0,0/)
     ig_vib(5,4,2,1:6) = (/1,0,0,0,0,3/)
     ig_vib(5,4,3,1:6) = (/2,0,2,0,2,0/)
     ig_vib(5,4,4,1:6) = (/2,2,0,2,0,0/)
     ig_vib(5,4,5,1:6) = (/2,0,2,0,2,3/)
     ig_vib(5,4,6,1:6) = (/2,2,0,2,0,3/)
     ig_vib(5,5,1,1:6) = (/0,0,1,0,0,0/)
     ig_vib(5,5,2,1:6) = (/1,0,0,0,0,0/)
     ig_vib(5,5,3,1:6) = (/2,0,2,0,2,0/)
     ig_vib(5,6,1,1:6) = (/1,0,0,2,1,4/)
     ig_vib(5,6,2,1:6) = (/2,2,0,0,1,4/)
     ig_vib(5,6,3,1:6) = (/2,0,2,2,4,4/)
     ig_vib(6,2,1,1:6) = (/2,0,0,0,2,4/)
     ig_vib(6,2,2,1:6) = (/2,0,0,3,2,4/)
     ig_vib(6,3,1,1:6) = (/2,0,0,2,0,4/)
     ig_vib(6,3,2,1:6) = (/2,0,0,2,3,4/)
     ig_vib(6,4,1,1:6) = (/1,0,0,1,2,4/)
     ig_vib(6,4,2,1:6) = (/2,0,2,1,0,4/)
     ig_vib(6,4,3,1:6) = (/2,2,0,4,2,4/)
     ig_vib(6,5,1,1:6) = (/1,0,0,2,1,4/)
     ig_vib(6,5,2,1:6) = (/2,2,0,0,1,4/)
     ig_vib(6,5,3,1:6) = (/2,0,2,2,4,4/)
     ig_vib(6,6,1,1:6) = (/0,0,1,0,0,0/)
     ig_vib(6,6,2,1:6) = (/0,1,0,0,0,0/)
     ig_vib(6,6,3,1:6) = (/0,0,1,3,0,0/)
     ig_vib(6,6,4,1:6) = (/0,1,0,0,3,0/)
     ig_vib(6,6,5,1:6) = (/1,0,0,0,3,0/)
     ig_vib(6,6,6,1:6) = (/1,0,0,3,0,0/)
     ig_vib(6,6,7,1:6) = (/2,0,2,0,2,0/)
     ig_vib(6,6,8,1:6) = (/2,2,0,2,0,0/)
     ig_vib(6,6,9,1:6) = (/1,0,0,3,3,0/)
     ig_vib(6,6,10,1:6) = (/1,0,0,4,4,0/)
     ig_vib(6,6,11,1:6) = (/2,0,2,3,2,0/)
     ig_vib(6,6,12,1:6) = (/2,0,2,4,1,0/)
     ig_vib(6,6,13,1:6) = (/2,2,0,1,4,0/)
     ig_vib(6,6,14,1:6) = (/2,2,0,2,3,0/)
     ig_vib(6,6,15,1:6) = (/1,0,0,4,4,3/)
     ig_vib(6,6,16,1:6) = (/2,0,2,4,1,3/)
     ig_vib(6,6,17,1:6) = (/2,2,0,1,4,3/)
     ig_rot(1,1,1,1:6) = (/1,0,0,0,0,0/)
     ig_rot(1,3,1,1:6) = (/1,0,0,1,2,2/)
     ig_rot(1,3,2,1:6) = (/1,0,0,2,1,2/)
     ig_rot(1,3,3,1:6) = (/2,0,2,1,0,2/)
     ig_rot(1,3,4,1:6) = (/2,2,0,0,1,2/)
     ig_rot(2,2,1,1:6) = (/1,0,0,0,0,0/)
     ig_rot(2,3,1,1:6) = (/1,0,0,1,2,1/)
     ig_rot(2,3,2,1:6) = (/1,0,0,2,1,1/)
     ig_rot(2,3,3,1:6) = (/2,0,2,1,0,1/)
     ig_rot(2,3,4,1:6) = (/2,2,0,0,1,1/)
     ig_rot(3,1,1,1:6) = (/1,0,0,1,2,2/)
     ig_rot(3,1,2,1:6) = (/1,0,0,2,1,2/)
     ig_rot(3,1,3,1:6) = (/2,0,2,1,0,2/)
     ig_rot(3,1,4,1:6) = (/2,2,0,0,1,2/)
     ig_rot(3,2,1,1:6) = (/1,0,0,1,2,1/)
     ig_rot(3,2,2,1:6) = (/1,0,0,2,1,1/)
     ig_rot(3,2,3,1:6) = (/2,0,2,1,0,1/)
     ig_rot(3,2,4,1:6) = (/2,2,0,0,1,1/)
     ig_rot(3,3,1,1:6) = (/0,0,1,0,0,0/)
     ig_rot(3,3,2,1:6) = (/0,1,0,0,0,0/)
     ig_rot(3,3,3,1:6) = (/0,0,1,3,0,0/)
     ig_rot(3,3,4,1:6) = (/0,1,0,0,3,0/)
     ig_rot(3,3,5,1:6) = (/1,0,0,0,3,0/)
     ig_rot(3,3,6,1:6) = (/1,0,0,3,0,0/)
     ig_rot(3,3,7,1:6) = (/2,0,2,0,2,0/)
     ig_rot(3,3,8,1:6) = (/2,2,0,2,0,0/)
     ig_rot(3,3,9,1:6) = (/1,0,0,3,3,0/)
     ig_rot(3,3,10,1:6) = (/1,0,0,4,4,0/)
     ig_rot(3,3,11,1:6) = (/2,0,2,3,2,0/)
     ig_rot(3,3,12,1:6) = (/2,0,2,4,1,0/)
     ig_rot(3,3,13,1:6) = (/2,2,0,1,4,0/)
     ig_rot(3,3,14,1:6) = (/2,2,0,2,3,0/)
     ig_rot(3,3,15,1:6) = (/1,0,0,4,4,3/)
     ig_rot(3,3,16,1:6) = (/2,0,2,4,1,3/)
     ig_rot(3,3,17,1:6) = (/2,2,0,1,4,3/)
     ig_cor(2,1,1,1:6) = (/2,0,0,1,0,1/)
     ig_cor(2,2,1,1:6) = (/2,0,0,1,0,2/)
     ig_cor(2,3,1,1:6) = (/2,0,0,0,2,4/)
     ig_cor(2,3,2,1:6) = (/2,0,0,3,2,4/)
     ig_cor(3,1,1,1:6) = (/2,0,0,0,1,1/)
     ig_cor(3,2,1,1:6) = (/2,0,0,0,1,2/)
     ig_cor(3,3,1,1:6) = (/2,0,0,2,0,4/)
     ig_cor(3,3,2,1:6) = (/2,0,0,2,3,4/)
     ig_cor(4,1,1,1:6) = (/1,0,0,0,0,1/)
     ig_cor(4,1,2,1:6) = (/2,2,0,2,0,1/)
     ig_cor(4,2,1,1:6) = (/1,0,0,0,0,2/)
     ig_cor(4,2,2,1:6) = (/2,2,0,2,0,2/)
     ig_cor(4,3,1,1:6) = (/1,0,0,1,2,4/)
     ig_cor(4,3,2,1:6) = (/2,0,2,1,0,4/)
     ig_cor(4,3,3,1:6) = (/2,2,0,4,2,4/)
     ig_cor(5,1,1,1:6) = (/1,0,0,0,0,1/)
     ig_cor(5,1,2,1:6) = (/2,0,2,0,2,1/)
     ig_cor(5,2,1,1:6) = (/1,0,0,0,0,2/)
     ig_cor(5,2,2,1:6) = (/2,0,2,0,2,2/)
     ig_cor(5,3,1,1:6) = (/1,0,0,2,1,4/)
     ig_cor(5,3,2,1:6) = (/2,2,0,0,1,4/)
     ig_cor(5,3,3,1:6) = (/2,0,2,2,4,4/)
     ig_cor(6,1,1,1:6) = (/1,0,0,1,2,2/)
     ig_cor(6,1,2,1:6) = (/1,0,0,2,1,2/)
     ig_cor(6,1,3,1:6) = (/2,0,2,1,0,2/)
     ig_cor(6,1,4,1:6) = (/2,2,0,0,1,2/)
     ig_cor(6,2,1,1:6) = (/1,0,0,1,2,1/)
     ig_cor(6,2,2,1:6) = (/1,0,0,2,1,1/)
     ig_cor(6,2,3,1:6) = (/2,0,2,1,0,1/)
     ig_cor(6,2,4,1:6) = (/2,2,0,0,1,1/)
     ig_cor(6,3,1,1:6) = (/0,0,1,0,0,0/)
     ig_cor(6,3,2,1:6) = (/0,1,0,0,0,0/)
     ig_cor(6,3,3,1:6) = (/0,0,1,3,0,0/)
     ig_cor(6,3,4,1:6) = (/0,1,0,0,3,0/)
     ig_cor(6,3,5,1:6) = (/1,0,0,0,3,0/)
     ig_cor(6,3,6,1:6) = (/1,0,0,3,0,0/)
     ig_cor(6,3,7,1:6) = (/2,0,2,0,2,0/)
     ig_cor(6,3,8,1:6) = (/2,2,0,2,0,0/)
     ig_cor(6,3,9,1:6) = (/2,0,2,3,2,0/)
     ig_cor(6,3,10,1:6) = (/2,2,0,2,3,0/)
     ipseudo(1,1:6) = (/1,0,0,2,2,0/)
     ipseudo(2,1:6) = (/1,0,0,2,2,3/)
     ipseudo(3,1:6) = (/2,0,2,1,4,0/)
     ipseudo(4,1:6) = (/2,0,2,2,3,0/)
     ipseudo(5,1:6) = (/2,2,0,3,2,0/)
     ipseudo(6,1:6) = (/2,2,0,4,1,0/)
     ipseudo(7,1:6) = (/2,0,2,2,3,3/)
     ipseudo(8,1:6) = (/2,2,0,3,2,3/)
     !
     g_vib(1,1,1) =  2./mX
     g_vib(1,2,1) =  -1./mX
     g_vib(1,3,1) =  -1./mX
     ...
     g_vib(6,5,2) =  1/mX
     g_vib(6,5,3) =  .500/mX
     g_vib(6,6,1) =  -1.*(-1.*mX-1.*mY)/mX/mY
     g_vib(6,6,2) =  -1.*(-1.*mX-1.*mY)/mX/mY
     g_vib(6,6,3) =  -1.*(mY+mX)/mX/mY
     g_vib(6,6,4) =  -1.*(mY+mX)/mX/mY
     g_vib(6,6,5) =  2./mX
     g_vib(6,6,6) =  2./mX
     g_vib(6,6,7) =  2./mX
     g_vib(6,6,8) =  2./mX
     ...
     g_rot(3,2,3) =  .500/mX
     g_rot(3,2,4) =  .500/mX
     g_rot(3,3,1) =  -.250*(-1.*mY-1.*mX)/mX/mY
     g_rot(3,3,2) =  -.250*(-1.*mY-1.*mX)/mX/mY
     g_rot(3,3,3) =  -.250*(mY+mX)/mX/mY
     g_rot(3,3,4) =  -.250*(mY+mX)/mX/mY
     g_rot(3,3,5) =  .500/mX
     g_rot(3,3,6) =  .500/mX
     g_rot(3,3,7) =  .500/mX
     g_rot(3,3,8) =  .500/mX
     ...
     g_cor(6,2,3) =  -1./mX
     g_cor(6,2,4) =  1/mX
     g_cor(6,3,1) =  .500*(-1.*mY-1.*mX)/mX/mY
     g_cor(6,3,2) =  -.500*(-1.*mY-1.*mX)/mX/mY
     g_cor(6,3,3) =  .500*(mX+mY)/mX/mY
     g_cor(6,3,4) =  -.500*(mX+mY)/mX/mY
     g_cor(6,3,5) =  -1./mX
     g_cor(6,3,6) =  1/mX
     g_cor(6,3,7) =  -1./mX
     g_cor(6,3,8) =  1/mX
