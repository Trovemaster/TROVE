...
! AS FITTING WAS CARRIED OUT USING THESE COORDINATES
  ...
  case default
    ...
    stop 'MLpoten_c2h6_88 error error: bad coordinate type'
    !
  case('R-R16-BETA16-THETA-TAU-2','R-R16-BETA16-THETA-TAU-4','R-R16-BETA16-THETA-TAU-5','R-R16-BETA16-THETA-TAU-6','R-R16-BETA16-THETA-TAU-7','R-R16-BETA16-THETA-TAU-8','R-R16-BETA16-THETA-TAU-9')
      !
      tau14 = local(14)
      tau24 = local(15)
      tau25 = local(16)
