...
module pot_user
  ...
  !   phi3 = dot_product(xyz(1, :) - xyz(4, :), xyz(2, :) - xyz(1, :))/sqrt(abs(dot_product(xyz(1, :) - xyz(4, :), xyz(2, :) - xyz(1, :)))) - cos(alpha_eq)
    phi1 = dot_product(xyz(3, :) - xyz(1, :), xyz(4, :) - xyz(1, :))/(r2*r3) - cos(alpha_eq)
    phi2 = dot_product(xyz(2, :) - xyz(1, :), xyz(4, :) - xyz(1, :))/(r1*r3) - cos(alpha_eq)
    phi3 = dot_product(xyz(2, :) - xyz(1, :), xyz(3, :) - xyz(1, :))/(r2*r1) - cos(alpha_eq)
